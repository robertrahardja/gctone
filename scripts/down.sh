...
smart_savings() {
  ...
  STACKS=("ctone-dev:tar-dev" "ctone-staging:tar-staging" "ctone-shared:tar-shared" "ctone-prod:tar-prod")
...
status_check() {
  ...
  local stack_names=("ctone-dev:tar-dev" "ctone-staging:tar-staging" "ctone-shared:tar-shared" "ctone-prod:tar-prod")
